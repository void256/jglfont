...
public class LwjglInitHelper {
  private Logger log = Logger.getLogger(LwjglInitHelper.class.getName());
  ...
  private boolean initGraphics(final String title, final int WIDTH, final int HEIGHT) {
    int width = 1920;
    int height = 1200;
    try {
...
//      GL11.glViewport(0, 0, Display.getDisplayMode().getWidth(), Display.getDisplayMode().getHeight());
  ...
  public void renderLoop(final RenderLoopCallback callback) {
    boolean done = false;
