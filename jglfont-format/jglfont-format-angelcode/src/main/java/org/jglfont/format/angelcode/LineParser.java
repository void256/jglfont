...
public class LineParser {
  ...
  public void parse(final String source, final LineData parsed) throws IOException {
  ...
  private void processToken(final LineData parsed) {
    switch (token) {
  ...
  private void processWord(final LineData parsed) {
    if (currentKey.length() == 0) {
